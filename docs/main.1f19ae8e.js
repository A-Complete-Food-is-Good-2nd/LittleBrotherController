...
},{"./stringify":"node_modules/qs/lib/stringify.js","./parse":"node_modules/qs/lib/parse.js","./formats":"node_modules/qs/lib/formats.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var label = 'dataChannel'; // URLからRoom IDと Signaling Keyをパース
...
document.querySelector("#explosion-sound").onclick = function () {
  sendData("swe");
};

document.querySelector("#warning-sound").onclick = function () {
  sendData("swa");
};
...
document.querySelector("#led-blink").onclick = function () {
  sendData("lbl");
};
...
//# sourceMappingURL=https://complete-foods-are-good-2nd.github.io/LittleBrotherController/main.1f19ae8e.js.map